...
|authenticationTypeId |If want to authenticate userId and password from your server [Set AccessToken Url](https://docs-test.kommunicate.io/docs/access-token-url-configuration) and pass authenticationTypeId 1. (Optional) |
