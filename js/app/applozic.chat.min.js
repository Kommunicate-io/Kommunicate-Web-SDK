...
var ALStorage = function (win) {
    ...
    return {
        ...
        getItem: function(item) {
            return (typeof (w.sessionStorage) !== "undefined") ? $applozic.parseJSON(w.sessionStorage.getItem(item)) : MCK_USER_SESSION[item];
        },
        removeItem: function(item) {
            typeof (w.sessionStorage) !== "undefined" && w.sessionStorage.removeItem(item);
        },
        setItem: function(item,data) {
            typeof (w.sessionStorage) !== "undefined" && w.sessionStorage.setItem(item, w.JSON.stringify(data))
        },
