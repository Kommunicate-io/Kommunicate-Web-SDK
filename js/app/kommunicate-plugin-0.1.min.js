...
a("#km-faq").removeClass("vis").addClass("n-vis"),"support"===tb&&a(".mck-tab-link").removeClass("vis").addClass("n-vis"),Db&&(u.removeClass("n-vis").addClass("vis"),B.addClass("mck-msg-w-panel")),fb&&(y.html("Deactivated"),y.removeClass("n-vis").addClass("vis").addClass("mck-no-mb"),A.removeClass("vis").addClass("n-vis")),aa.subscibeToTypingChannel(l.tabId,l.isGroup),"function"===typeof Ab&&Ab({tabId:l.tabId,isGroup:l.isGroup});else if(l.tabId="",gb&&m.hideOfflineMessage(),ec.removeClass("vis").addClass("n-vis"),
a("#km-faq").removeClass("n-vis").addClass("vis"),D.removeClass("n-vis").addClass("vis"),Ba.removeClass("n-vis").addClass("vis"),F.removeClass("vis").addClass("n-vis"),B.data("mck-id",""),B.data("mck-conversationid",""),B.data("mck-topicid",""),u.removeClass("vis").addClass("n-vis"),B.removeClass("mck-msg-w-panel"),Q.removeClass("vis").addClass("n-vis"),gc.removeClass("vis").addClass("n-vis"),n.val(""),r=C.getLatestMessageArray(),aa.unsubscibeToTypingChannel(),null!==r&&0<r.length){l.isReload=!0;
m.addContactsFromMessageList({message:r},l);b.openConversation();Ga=!1;return}x.loadMessageList(l,e);b.openConversation()};b.setProductProperties=function(a,c){N.html(a.title);L.html(b.getTopicLink(a.link));Y.html(a.subtitle?a.subtitle:"");var l=a.value1?":"+a.value1:"";Jb.html(a.key1?a.key1:"");da.html(l);l=a.value2?":"+a.value2:"";ia.html(a.key2?a.key2:"");fa.html(l);"function"===typeof xb&&(a.topicId=c,xb(a))};b.getTopicLink=function(a){return a?'\x3cimg src\x3d"'+a+'"\x3e':'\x3cspan class\x3d"mck-icon-no-image"\x3e\x3c/span\x3e'};
b.processMessageList=function(l,c,e){var k=B.children("div[name\x3d'message']:first"),r=B.data("mck-id"),q=B.data("isgroup")?mckGroupUtils.getGroup(r):m.fetchContact(r);if("undefined"===typeof l.message.length){r=[];r.push(l.message);C.updateMckMessageArray(r);b.addMessage(l.message,q,!1,!1,e);var f=l.createdAtTime}else C.updateMckMessageArray(l.message),a.each(l.message,function(a,l){"undefined"!==typeof l.to&&(b.addMessage(l,q,!1,!1,e),f=l.createdAtTime)});Q.data("datetime",f);!c&&0<k.length?B.scrollTop(k.offset().top-
B.offset().top+B.scrollTop()):c&&B.animate({scrollTop:B.prop("scrollHeight")},"fast")};b.closeConversation=function(a){var b;if("function"===typeof zb){var l=zb();"object"===typeof l&&(b="BUSY_WITH_OTHER"===a?l.onBusyWithOtherUser:l.onConversationClose)}b||(b="Chat disabled with user");y.html(b);y.removeClass("n-vis").addClass("vis").addClass("mck-no-mb");A.removeClass("vis").addClass("n-vis")};b.addTooltip=function(b){a("."+b+" .mck-icon-time").attr("title","pending");a("."+b+" .mck-btn-trash").attr("title",
"delete");a("."+b+" .mck-icon-sent").attr("title","sent");a("."+b+" .mck-btn-forward").attr("title","forward message");a("."+b+" .mck-icon-delivered").attr("title","delivered");a("."+b+" .mck-icon-read").attr("title","delivered and read");a("."+b+" .msgtype-outbox-cr").attr("title","sent via Carrier");a("."+b+" .msgtype-outbox-mck").attr("title","sent");a("."+b+" .msgtype-inbox-cr").attr("title","received via Carrier");a("."+b+" .msgtype-inbox-mck").attr("title","recieved")};b.fetchContact=function(a){var l=
b.getContact(a);"undefined"===typeof l&&(l=b.createContact(a));return l};b.getContact=function(a){if("object"===typeof Na[a])return Na[a]};b.getContactDisplayName=function(a){if("string"===typeof ta[a])return ta[a];if("undefined"===typeof ta[a]){var b=ha[a];if("undefined"!==typeof b)return b.displayName;b=[];b.push(a);X.getUsersDetail(b,{async:!1});b=ca.getUserDetail(a);if("undefined"!==typeof b)return b.displayName}};b.sendUserEmail=function(){if(1<document.getElementById("input-for-email").value.length){var b=
document.getElementById("input-for-email").value;X.updateUser({data:{email:b},success:function(b){console.log("email updated successfully !");a("#input-for-email").after("\x3cdiv style\x3d'width: 100px; margin: auto;'\x3e\x3cspan\x3eEmail Sent\x3c/span\x3e\x3c/div\x3e");a("#input-for-email").remove();a("#send-email-button").remove()},error:function(a){}})}else alert("No email")};b.updateMetadata=function(a,b){a=c.JSON.stringify({key:a,metadata:b});mckUtils.ajax({type:"POST",url:MCK_BASE_URL+"/rest/ws/message/update/metadata",
global:!1,data:a,contentType:"application/json",success:function(a){console.log("metadata cleared successfully !")}})};b.addMessage=function(l,k,q,f,Q){var r,g="",h="",p="";var D="vis";var Ra="n-vis",hc="",F="n-vis";if("object"===typeof l.metadata&&"undefined"!==typeof l.metadata.AL_REPLY&&(g=l.metadata.AL_REPLY,h=x.getReplyMessageByKey(g),"undefined"!==typeof h)){if(k.isGroup&&h||!k.isGroup&&"undefined"===typeof h.fileMeta)F="vis";hc=5===h.type?"You":m.getTabDisplayName(h.to,!1);if("object"===typeof h.fileMeta||
2===h.contentType)p=b.getImageForReplyMessage(h),D="n-vis",Ra="vis",F="n-vis"}if(6!==l.type&&7!==l.type&&!(l.metadata&&"HIDDEN"===l.metadata.category||102===l.contentType||l.metadata&&(l.metadata.KM_ASSIGN||l.metadata.KM_STATUS)||10===l.contentType&&l.metadata&&"true"===l.metadata.hide||0<a("#mck-message-cell ."+l.key).length)){G.hasClass("vis")&&G.removeClass("vis").addClass("n-vis");var n="mck-msg-right",N="mck-icon-time";if(0===l.type||4===l.type||6===l.type)n="mck-msg-left";if(4===l.contentType||
10===l.contentType||103===l.contentType)n="mck-msg-center";N=b.getStatusIconName(l);g=l.key;var E="'"+l.deviceKey+"','"+l.to+"','"+l.to+"','"+g+"'",K="",A="",L="",ib="n-vis",u="";X.loadUserProfile(l.to);!l.groupId||4===l.contentType||7===k.type||0!==l.type&&4!==l.type&&6!==l.type||(K=b.getTabDisplayName(l.to,!1),ib="vis",L=b.getNameTextClassByAlphabet(K));if(Tb){u="mck-msg-avator-bubble";var w="",ja=K;"mck-msg-right"===n?(w=m.fetchContact(z),ja=b.getTabDisplayName(w.displayName,!1)):"mck-msg-left"===
n&&(w=l.groupId?m.fetchContact(l.to):k);w&&(A=b.getContactImageLink(w,ja))}l.groupId&&10===l.contentType&&(L=A=K="");w="n-vis";var ic=ja="",P=l.message;"object"===typeof l.fileMeta&&(ja=l.fileMeta.name,ic=l.fileMeta.size);"object"===typeof l.fileMeta&&(l.fileMeta.contentType.indexOf("audio")||l.fileMeta.contentType.indexOf("image")||l.fileMeta.contentType.indexOf("video"))&&(w="vis");var Y="n-vis";lb&&c.MCK_OL_MAP[l.to]&&10!==l.contentType&&(Y="vis");k=Kommunicate.isRichTextMessage(l.metadata);p=
[{msgReply:h?h.message+"\n":"",msgReplyTo:h?hc+"\n":"",msgReplyDivExpr:h?"vis":"n-vis",msgReplyToVisibleExpr:F,msgPreview:p?b.getImageForReplyMessage(h):"",msgpreviewvisExpr:Ra,textreplyVisExpr:D,msgKeyExpr:l.key,msgDeliveredExpr:l.delivered,msgSentExpr:l.sent,msgCreatedAtTime:l.createdAtTime,msgTypeExpr:l.type,msgDeleteExpr:MCK_LABELS["delete"],msgReplyExpr:MCK_LABELS.reply,msgForwardExpr:MCK_LABELS.forward,msgForwardVisibleExpr:"kommunicate"==window.applozic.PRODUCT_ID?"n-vis":"vis",msgSourceExpr:l.source,
statusIconExpr:N,contactExpr:"vis",toExpr:l.to,msgAvatorClassExpr:u,showNameExpr:ib,msgNameExpr:K,msgImgExpr:A,nameTextExpr:L,msgFloatExpr:n,replyIdExpr:g,createdAtTimeExpr:mckDateUtils.getDate(l.createdAtTime),msgFeatExpr:"n-vis",replyMessageParametersExpr:E,downloadMediaUrlExpr:b.getFileAttachment(l),msgClassExpr:"",msgExpr:P,selfDestructTimeExpr:l.timeToLive,fileMetaKeyExpr:l.fileMetaKey,downloadIconVisibleExpr:w,fileExpr:b.getFilePath(l),fileUrlExpr:b.getFileurl(l),fileNameExpr:ja,fileSizeExpr:ic,
contOlExpr:Y,kmRichTextMarkupVisibility:k?"vis":"n-vis",kmRichTextMarkup:k?Kommunicate.getRichTextMessageTemplate(l.metadata):"",containerType:Kommunicate.getConatainerTypeForRichMessage(l.metadata)}];q?a.tmpl("messageTemplate",p).appendTo("#mck-message-cell .mck-message-inner"):a.tmpl("messageTemplate",p).prependTo("#mck-message-cell .mck-message-inner");if(23===l.contentType){if("BUTTON"===l.metadata.msg_type){D=[];if(l.metadata.payload){if(D=a.parseJSON(l.metadata.payload),D[0].hidden||(r="\x3cdiv style\x3d'width: 100px; margin: auto;'\x3e\x3cbutton style\x3d'height: 27px;color: #FFF;background-color: #000;border-radius: 10px; width: 100px; margin: 10px;'\x3e"+
...
($applozic("#km-faqanswer").append('\x3cdiv class\x3d"km-faqanswer-list"\x3e\x3cdiv class\x3d"km-faqquestion"\x3e'+a.data.title+'\x3c/div\x3e \x3cdiv class\x3d"km-faqanchor km-faqanswer"\x3e'+a.data.body+"\x3c/div\x3e\x3c/div\x3e"),$applozic(".mck-faq-inner").removeClass("vis").addClass("n-vis"),$applozic(".km-faqanswer").removeClass("n-vis").addClass("vis"),$applozic(".km-faqsearch").removeClass("vis").addClass("n-vis"),$applozic("#mck-no-conversations").removeClass("vis").addClass("n-vis"),$applozic(".mck-sidebox-ft").removeClass("vis").addClass("n-vis"))},
error:function(){}})});$applozic(d).on("click","#km-faq",function(){document.getElementById("km-faqdiv").hasChildNodes()?($applozic(".mck-message-inner").removeClass("vis").addClass("n-vis"),$applozic("#mck-conversation-title").removeClass("vis").addClass("n-vis"),$applozic("#mck-contacts-content").removeClass("vis").addClass("n-vis"),$applozic("#km-faq").removeClass("vis").addClass("n-vis"),$applozic(".mck-faq-inner").removeClass("n-vis").addClass("vis"),$applozic(".km-faqback").removeClass("n-vis").addClass("vis"),
$applozic(".km-faqtitle").removeClass("n-vis").addClass("vis"),$applozic(".km-faqsearch").removeClass("n-vis").addClass("vis"),$applozic("#km-faqdiv").removeClass("n-vis").addClass("vis"),$applozic("#mck-no-conversations").removeClass("vis").addClass("n-vis"),$applozic(".mck-sidebox-ft").removeClass("vis").addClass("n-vis")):$applozic("#km-faqdiv").removeClass("vis").addClass("n-vis")});$applozic(d).on("click","#km-faqanswer a",function(a){a.preventDefault();window.open(a.target.href)});$applozic("#km-faq-search-input").keydown(function(n){clearTimeout(e);
e=setTimeout(function(){KommunicateKB.getArticles({data:{appId:a.appId,query:document.getElementById("km-faq-search-input").value,helpdocsAccessKey:c},success:function(a){$applozic("#km-faqdiv").empty();$applozic.each(a.data,function(a,c){$applozic("#km-faqdiv").append('\x3cli class\x3d"km-faq-list" data-source\x3d"'+c.source+'" data-articleId\x3d"'+c.articleId+'"\x3e\x3ca class\x3d"km-faqdisplay"\x3e \x3cdiv\x3e\x3cdiv class\x3d"km-faqimage"\x3e\x3c/div\x3e\x3c/div\x3e \x3cdiv class\x3d"km-faqanchor"\x3e'+
c.title+"\x3c/div\x3e\x3c/a\x3e\x3c/li\x3e")})},error:function(){}})},2E3);32!=n.which&&13!=n.which||KommunicateKB.getArticles({data:{appId:a.appId,query:document.getElementById("km-faq-search-input").value,helpdocsAccessKey:c},success:function(a){$applozic("#km-faqdiv").empty();$applozic.each(a.data,function(a,c){$applozic("#km-faqdiv").append('\x3cli class\x3d"km-faq-list" data-source\x3d"'+c.source+'" data-articleId\x3d"'+c.articleId+'"\x3e\x3ca class\x3d"km-faqdisplay"\x3e \x3cdiv\x3e\x3cspan class\x3d"km-faqimage"/ \x3e\x3c/span\x3e \x3cdiv class\x3d"km-faqanchor "\x3e'+
c.title+"\x3c/div\x3e\x3c/a\x3e\x3c/li\x3e")})},error:function(){}})});$applozic(d).on("click",".km-faqback",function(){$applozic("#km-faqanswer").hasClass("vis")?($applozic(".mck-faq-inner").removeClass("n-vis").addClass("vis"),$applozic("#km-faqanswer").removeClass("vis").addClass("n-vis"),$applozic(".km-faqsearch").removeClass("n-vis").addClass("vis")):($applozic(".mck-message-inner").removeClass("n-vis").addClass("vis"),$applozic("#mck-conversation-title").removeClass("n-vis").addClass("vis"),
$applozic("#mck-contacts-content").removeClass("n-vis").addClass("vis"),$applozic("#km-faq").removeClass("n-vis").addClass("vis"),$applozic(".mck-faq-inner").removeClass("vis").addClass("n-vis"),$applozic(".km-faqback").removeClass("vis").addClass("n-vis"),$applozic(".km-faqtitle").removeClass("vis").addClass("n-vis"),$applozic(".km-faqsearch").removeClass("vis").addClass("n-vis"))})};
