...
//      var MCK_AWS_S3_SERVER = (appOptions.awsS3Server)?appOptions.awsS3Server:false;
        ...
        function MckInit() {
            ...
            _this.getLauncherHtml = function (isannoynouschat) {
                ...
                var askUserDetailsWidget = `<div id="launcher-svg-container"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 500 500" width="56" height="56" style="enable-background:new 0 0 500 500;" xml:space="preserve">
                <style type="text/css">
                    .km-launcher-logo-0{fill:url(#km-launcher-logo-gradient-2);}
                    .km-launcher-logo-1{fill:#FFFFFF;}
                </style>
                <g>
                    <linearGradient id="km-launcher-logo-gradient-2" gradientUnits="userSpaceOnUse" x1="3.367313e-08" y1="250" x2="500" y2="250">
                        <stop offset="0" style="stop-color:#3A3C80"/>
                        <stop offset="0.1658" style="stop-color:#4B4C93"/>
                        <stop offset="0.3516" style="stop-color:#5858A2"/>
                        <stop offset="0.5063" style="stop-color:#5C5CA7"/>
                ...
                if (isannoynouschat) {
                    return '<a href="#" target="_self">' + (CUSTOM_CHAT_LAUNCHER ? CUSTOM_CHAT_LAUNCHER : askUserDetailsWidget) + '</a>';
                } else {
