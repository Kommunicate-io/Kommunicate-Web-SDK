...
function MckDateUtils() {
    ...
    _this.getTimeOrDate = function (createdAtTime, timeFormat) {
        ...
        // var date = new Date(createdAtTime);
        // var currentDate = new Date();
        // var diff = Math.abs(currentDate - date);
        // var minutes = Math.floor((diff / 1000) / 60);
        // if (minutes < minInTwoDays) {
        //     if (minutes < 60) {
        //         lastSeen = moment.unix(createdAtTime / 1000).fromNow();
        //         console.log(minutes,lastSeen);
        //         lastSeen = lastSeen.replace("minutes", "mins");
        //     } else {
        //         var hour = Math.floor(minutes / 60)
        //         lastSeen = hour + " hrs ago";
        //     }
        // } else {
        //     lastSeen = moment.unix(createdAtTime / 1000).format("DD MMMM YYYY");
        // }
        // return lastSeen;
    };
