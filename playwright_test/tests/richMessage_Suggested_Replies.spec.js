...
// Launching widget
  ...
  // The message Response verify that the message was successfully sent
    await iframe.locator(RICHMESSAGES_LOCATORS.kmSuggestedRepliesYesBtn)
                .click();
    await page.waitForTimeout(2000)
    const isVisible = await iframe.locator(RICHMESSAGES_LOCATORS.kmSuggestedRepliesYesBtnResponse).isVisible();
