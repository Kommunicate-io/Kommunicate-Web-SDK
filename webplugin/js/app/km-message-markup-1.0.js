Kommunicate.messageTemplate = {
    ...
    getAttachmentApplicationTemplate: function(attachment) {
        ...
        {{fileMeta.name}} {{fileMeta.previewSize}}</a></div><div class="km-attachment-progress-bar-wrapper km-attachment-progress-bar-wrapper-{{key}} {{progressBarClass}}"><div class="km-attachment-progress-bar-success km-attachment-progress-bar-success-{{key}} vis"></div></div></div>`;
    },
...
Kommunicate.popupChatTemplate = {
    ...
    getPopupChatTemplate: function(popupWidgetContent, widgetTheme, isAnonymousChat) {
