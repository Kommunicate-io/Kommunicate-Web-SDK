...
//      var MCK_AWS_S3_SERVER = (appOptions.awsS3Server)?appOptions.awsS3Server:false;
        ...
        function MckInit() {
            ...
            _this.restrictScrollOnHandHeldDevices = function() {
                ...
                var parentBody = parent.parent && parent.parent.document.body;
                var parentHead = parent.parent && parent.parent.document.head;
                var parentHtmlTag = parent.parent && parent.parent.document.getElementsByTagName('html')[0];
