...
(function ($applozic, w, d) {
    ...
    function Applozic(appOptions) {
        ...
        // ensure voice web CTA stays hidden until explicitly enabled
        ...
        function openWidgetIframe() {
            ...
            if (POPUP_WIDGET) {
                ...
                typeof _this.configurePopupWidget === 'function' && _this.configurePopupWidget();
            } else {
        ...
        _this.mckLaunchSideboxChat = function () {
            ...
            var shouldSkipLeadCollectionConversation =
            ...
            console.log('[PRE-LEAD] mckLaunchSideboxChat', {
            ...
            !shouldSkipLeadCollectionConversation &&
            ...
            $applozic(previewIndicator).hasClass('vis') &&
                kommunicateCommons.hide(previewIndicator);
        ...
        function MckInit() {
            ...
            function isLivechatDemoContext() {
                try {
                    if (
                        window.location &&
                        typeof window.location.pathname === 'string' &&
                        window.location.pathname.indexOf('/livechat-demo') !== -1
                    ) {
                        return true;
                    }
                } catch (err) {}
                try {
                    if (
                        ...
                        typeof window.parent.location.pathname === 'string' &&
                        window.parent.location.pathname.indexOf('/livechat-demo') !== -1
                    ) {
                        return true;
                    }
                } catch (err) {}
                try {
                    var parentFrame =
                        parent.document &&
                        parent.document.getElementById('kommunicate-widget-iframe');
                    var dataUrl = parentFrame && parentFrame.getAttribute('data-url');
                    if (dataUrl && dataUrl.indexOf('/livechat-demo') !== -1) {
                        return true;
                    }
                } catch (err) {}
                try {
                    var frameEl = window.frameElement;
                    var frameDataUrl = frameEl && frameEl.getAttribute('data-url');
                    if (frameDataUrl && frameDataUrl.indexOf('/livechat-demo') !== -1) {
                        return true;
                    }
                } catch (err) {}
                try {
                    if (
                        ...
                        document.referrer &&
                        document.referrer.indexOf('/livechat-demo') !== -1
                    ) {
                        return true;
                    }
                } catch (err) {}
            ...
            if (typeof window !== 'undefined' && !window.isLivechatDemoContext) {
                window.isLivechatDemoContext = isLivechatDemoContext;
            }
            ...
            function autoOpenPreChatLeadCollectionModal(launcher) {
                ...
                console.log(
                    '[PRE-LEAD] autoOpenPreChatLeadCollectionModal invoked, launcher:',
                    launcher
                );
            ...
            function ensureAuthFailureFormFields() {
                if (typeof document === 'undefined') {
                    return;
                }
                ...
                if (userIdInput) {
                    ...
                    var userIdLabel = MCK_LABELS['form.label.userId'] || 'User ID';
                ...
                if (!document.getElementById('km-password')) {
                    var passwordLabel =
                        (MCK_LABELS['lead.collection'] || {}).password || 'Password';
            ...
            function openWidgetForAuthError() {
                ...
                var skipConversationOpen = isLivechatDemoContext();
                if (
                ...
                if (!skipConversationOpen && $applozic?.fn?.applozic) {
                ...
                if (!isValidated) {
                    if (
                        ...
                        if (
                            ...
                            mckInit.initialize(options, mckMessageService.loadChat);
                            return false;
                        }
                        ...
                        for (var i = 0; i < kmAnonymousChatLauncherClass.length; i++) {
                            kmAnonymousChatLauncherClass[i].addEventListener(
                                ...
                                function (event) {
                                    ...
                                    kmChatLoginModal &&
                                        setTimeout(
                                            showPreChatLeadModal,
                                            PRE_CHAT_LEAD_COLLECTION_MODAL_DISPLAY_DELAY
                                        );
                                    !POPUP_WIDGET &&
                ...
                window.Applozic.ALApiService.login({
                    ...
                    success: async function (result) {
                        ...
                        if (
                            ...
                            emitAuthFailurePostMessage(resultCode, normalizedResult);
                            var isPreLeadEnabled = isPreLeadCollectionEnabled();
                            var leadLabels = MCK_LABELS['lead.collection'] || {};
                            var livechatAuthMessage =
                                leadLabels.invalidPasswordMessage ||
                                leadLabels.invalidPassword ||
                                leadLabels.errorText;
                            var dashboardAuthMessage =
                                leadLabels.dashboardCredentialError ||
                                leadLabels.invalidPasswordMessage ||
                                leadLabels.invalidPassword ||
                                leadLabels.errorText;
                            var loginErrorMessage = isPreLeadEnabled
                                ? livechatAuthMessage
                            ...
                            if (!AUTH_SUBMIT_TRIGGERED) {
                                ...
                                if (!isPreLeadEnabled && isLivechatDemoContext()) {
                                ...
                                if (!isPreLeadEnabled && !isLivechatDemoContext()) {
                                    var loginErrorNode = document.getElementById(
                                        'km-error-chat-login'
                                    );
                                    if (loginErrorNode) {
                                    ...
                                    if (passwordInput) {
                                        var passwordContainer =
                                            typeof passwordInput.closest === 'function'
                                                ? passwordInput.closest('.km-form-group')
                                                : null;
                                        if (passwordContainer) {
                                            kommunicateCommons.hide(passwordContainer);
                                        } else {
                                            passwordInput.classList.add('n-vis');
                                        }
                                    }
                                    var submitBtn = document.getElementById('km-submit-chat-login');
                                    if (submitBtn) {
                                        submitBtn.setAttribute('disabled', true);
                                        submitBtn.classList.add('n-vis');
                                    }
                                }
                            ...
                            var shouldShowLivechatAuthForm =
                                isLivechatDemoContext() && !isPreLeadEnabled;
                            if (shouldShowLivechatAuthForm) {
                                ensureAuthFailureFormFields();
                            }
                            var invalidPasswordMessage =
                                leadLabels.invalidPassword || leadLabels.errorText;
                            if (isPreLeadEnabled && MCK_AUTHENTICATION_TYPE_ID <= 0) {
                                ...
                                var hasPreLeadPassword = KM_PRELEAD_COLLECTION.some(function (
                                    item
                                ) {
                                    return (
                                        item &&
                                ...
                                var passwordInput = document.getElementById('km-password');
                                if (passwordInput && !hasPreLeadPassword) {
                                    var passwordContainer =
                                        typeof passwordInput.closest === 'function'
                                            ? passwordInput.closest('.km-form-group')
                                            : null;
                            ...
                            if (
                                !isPreLeadEnabled &&
                                !shouldShowLivechatAuthForm &&
                                !document.getElementById('km-password')
                            ) {
                            ...
                            if (submitBtn) {
                                ...
                                submitBtn.innerHTML = submitLabel;
                                submitBtn.setAttribute('aria-label', submitLabel);
                                if (shouldShowLivechatAuthForm || isPreLeadEnabled) {
                                    submitBtn.classList.remove('n-vis');
                                    submitBtn.removeAttribute('disabled');
                                }
                            }
            ...
            _this.loadDataPostInitialization = function () {
                ...
                if (showPoweredBy) {
                    ...
                    kommunicateCommons.show('.mck-running-on');
                }
            ...
            _this.addLeadCollectionInputDiv = function () {
                ...
                if (
                    typeof MCK_AUTHENTICATION_TYPE_ID !== 'undefined' &&
                    MCK_AUTHENTICATION_TYPE_ID > 0
                ) {
                    var hasUserId = KM_PRELEAD_COLLECTION.some(function (item) {
                        return (
                            item &&
                            typeof item.field === 'string' &&
                            item.field.toLowerCase().replace(/\s+/g, '') === 'userid'
                    ...
                    var hasPassword = KM_PRELEAD_COLLECTION.some(function (item) {
                        return (
                            item &&
                            typeof item.field === 'string' &&
                            item.field.toLowerCase().replace(/\s+/g, '') === 'password'
        ...
        function MckMessageService() {
            ...
            _this.hideAutoSuggestionBoxEnableTxtBox = function () {
                if ($mck_autosuggest_search_input.hasClass('mck-text-box')) {
                    kommunicateCommons.hide($mck_autosuggest_search_input);
                    $mck_autosuggest_search_input.removeClass('mck-text-box').val('');
                    kommunicateCommons.show($mck_text_box);
                    $mck_text_box.addClass('mck-text-box');
            ...
            */
                ...
                window.Applozic.ALApiService.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (
                            ...
                            kommunicateCommons.show($mck_business_hours_box);
            ...
            _this.handleBusinessHoursBannerShow = function () {
                ...
                function showBanner() {
                    kommunicateCommons.show($mck_business_hours_box);
                    $mck_business_hours_box.text(
                        BUSINESS_HOUR_SETTING.message || MCK_LABELS['business-hour.msg']
                    );
                }
            ...
            _this.init = function () {
                ...
                $applozic('#km-form-chat-login').submit(function (e) {
                    ...
                    console.log('[PRE-LEAD] submit login: initializing user', {
                        userId,
                        anonymous: Boolean(!email && !contactNumber),
                    });
                ...
                $applozic(d).on('click', '.mck-btn-remove-member', function (e) {
                    ...
                    if (typeof groupId !== 'undefined' && typeof userId !== 'undefined') {
                        ...
                        if (typeof group === 'object' && MCK_USER_ID === group.adminName) {
                            ...
                            kommunicateCommons.hide('.mck-group-admin-options');
                        }
                    }
                });
                ...
                $mck_group_add_member.on('click', function (e) {
                    ...
                    if (groupId) {
                        ...
                        if (group && group.adminName === MCK_USER_ID) {
                            ...
                            kommunicateCommons.show('#mck-gms-loading');
                            if (MCK_GROUP_MEMBER_SEARCH_ARRAY.length > 0) {
                                ...
                                if (MCK_CONTACT_ARRAY.length > 0) {
                                    ...
                                    kommunicateCommons.hide('#mck-gms-loading');
                                    kommunicateCommons.show('#mck-no-gsm-text');
                                }
                            } else {
                    ...
                    if ($mck_text_box && $mck_text_box.data('fieldType')) {
                        ...
                        if ($mck_text_box.data('validation')) {
                            ...
                            if (!regexForm.test(message)) {
                                ...
                                kommunicateCommons.show('#mck-form-field-error-alert-box');
                                setTimeout(function () {
                                    kommunicateCommons.hide('#mck-form-field-error-alert-box');
                                }, 2000);
                                return false;
                            }
                        }
            ...
            _this.closeSideBox = function () {
                ...
                kommunicateCommons.show('#mck-sidebox-launcher');
                var launcherAgentImg = document.getElementById('launcher-agent-img-container');
                var launcherSvgSelector = '#mck-sidebox-launcher #launcher-svg-container';
            ...
            _this.sendMessage = function (messagePxy, file, callback) {
                ...
                if (messagePxy.to) {
                    if (
                        ...
                        kommunicateCommons.show($mck_msg_error);
                        kommunicateCommons.hide(
                            '#mck-tab-status',
                            '#mck-msg-form',
                            '#li-mck-block-user'
                ...
                if (messagePxy.message && FILE_META.length === 0) {
                    ...
                    $applozic.each(FILE_META, function (i, fileMeta) {
                        ...
                        if (FILE_META && KommunicateUI.isAttachmentV2(FILE_META[0].contentType)) {
                            kommunicateCommons.hide('.mck-timestamp-' + messagePxy.key);
            ...
            _this.submitMessage = function (messagePxy, optns) {
                ...
                window.Applozic.ALApiService.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (
                            ...
                            kommunicateCommons.show('.mck-timestamp-' + messagePxy.key);
                ...
                kommunicateCommons.hide('#mck-reply-to-div');
            };
            ...
            _this.replyMessage = function (msgKey) {
                ...
                kommunicateCommons.show('#mck-reply-to-div');
                if (message.type === 5) {
                    displayName = 'You';
                } else {
                            ...
                            if (data === 'success') {
                                ...
                                if (currentTabId === tabId) {
                                    ...
                                    if ($mck_msg_inner.is(':empty')) {
                                        kommunicateCommons.hide($mck_tab_message_option);
                                    }
                                }
                                ALStorage.clearMckMessageArray();
                            } else {
                    ...
                    window.Applozic.ALApiService.deleteConversation({
                        ...
                        success: function () {
                            ...
                            if (currentTabId === tabId) {
                                ...
                                // kommunicateCommons.show('#mck-no-messages');
                                kommunicateCommons.hide('.mck-tab-message-option');
                                CONTACT_SYNCING = false;
                            }
                        },
                    ...
                    success: function (data) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (individual) {
                                    if (params.startTime) {
                                        // kommunicateCommons.show('#mck-no-more-messages');
                                        // $mck_no_more_messages.fadeOut(5000, function () {
                                        //     kommunicateCommons.hide('#mck-no-more-messages');
                                        // });
                                        $mck_tab_option_panel.data('datetime', '');
                                    } else if (
                                        !params.isGroup &&
                                    ...
                                    if (params.startTime) {
                                        // kommunicateCommons.show('#mck-no-more-conversations');
                                        // $mck_no_more_conversations.fadeOut(5000, function () {
                                        //     kommunicateCommons.hide('#mck-no-more-conversations');
                                        // });
                                    } else {
                                        // kommunicateCommons.hide('#mck-no-messages');
                                    ...
                                    if (isMessages) {
                                        if (params.startTime > 0) {
                                            ...
                                            if (!params.isGroup) {
                                                ...
                                                kommunicateCommons.show($mck_tab_message_option);
                                            }
                                        }
                                    }
                                        ...
                                        $applozic.each(data.groupFeeds, function (i, groupFeed) {
                                            ...
                                            if (!params.startTime) {
                                                ...
                                                if (userIdArray.length > 0) {
                                                    ...
                                                    kommunicateCommons.hide($mck_loading);
                                                    if (isMessages) {
                                                        // kommunicateCommons.hide('#mck-no-messages');
            ...
            _this.updateConversationHeader = function (params) {
                ...
                if (params.imageUrl) {
                    ...
                    kommunicateCommons.show('.mck-agent-image-container img');
                    kommunicateCommons.hide(
                    ...
                    kommunicateCommons.hide('.mck-agent-image-container img');
                }
        ...
        function MckMessageLayout() {
            ...
            var SUBMITTED_FORMS = {};
            function getSafeInlineTemplateTitle(title) {
            ...
            function buildTemplateButton(title) {
                var safeTitle = getSafeInlineTemplateTitle(title);
                var buttonWrap = d.createElement('div');
                buttonWrap.className = 'km-inline-template__button-wrap';

                var button = d.createElement('button');
                button.type = 'button';
                button.className = 'km-inline-template__button';
                button.textContent = safeTitle;
            ...
            function buildTemplateInputRow(title, options) {
                var opts = options || {};
                var withIds = !!opts.withIds;
                var wrapper = d.createElement('div');
                wrapper.className = 'km-inline-template__input-row';
                ...
                var button = d.createElement('button');
                button.type = 'button';
                button.className = 'km-inline-template__submit';
                button.textContent = getSafeInlineTemplateTitle(title);

                if (withIds) {
                    inlineTemplateIdCounter += 1;
                    var safeIdSuffix =
                        typeof opts.idSuffix === 'string'
                            ? opts.idSuffix.replace(/[^a-zA-Z0-9_-]/g, '')
                            : inlineTemplateIdCounter;
                    if (!safeIdSuffix) {
                        safeIdSuffix = inlineTemplateIdCounter;
                    }
                    input.id = 'input-for-email-' + safeIdSuffix;
                    button.id = 'send-email-button-' + safeIdSuffix;
                }
            ...
            _this.loadTab = function (params, callback) {
                ...
                if (params.tabId) {
                    ...
                    if (params.isGroup) {
                        ...
                        kommunicateCommons.show('#li-mck-block-user');
                    }
                    ...
                    if (params.topicId) {
                        ...
                        if (typeof topicDetail === 'object') {
                            if (IS_MCK_TOPIC_HEADER) {
                                ...
                                kommunicateCommons.show($mck_conversation_header);
                            } else if (IS_MCK_TOPIC_BOX) {
                                _this.setProductProperties(topicDetail, params.topicId);
                                kommunicateCommons.hide($product_box_caret);
                                $mck_product_box.addClass('mck-product-box-wc');
                                kommunicateCommons.hide($mck_conversation_list);
                                kommunicateCommons.show('#mck-product-box');
                            }
                        }
                    }
                    if (IS_MCK_LOCSHARE && w.google && typeof w.google.maps === 'object') {
                        kommunicateCommons.hide('#mck-attachfile-box');
                        kommunicateCommons.show('#mck-location-sharing-box');
                    } else {
                        kommunicateCommons.hide('#mck-location-sharing-box');
            ...
            _this.processMessageList = function (data, scroll, isValidated, append, allowReload) {
                ...
                if (data && (data.message || data.message === 0)) {
                    ...
                    hasMessages && KommunicateUI.setHasConversationHistory(true);
                }
                    ...
                    for (var i = 0, len = elements.length; i < len; ++i) {
                        switch (elements[i].type) {
                            ...
                            case 'checkbox':
                                ...
                                break;
                            case 'submit':
                                kommunicateCommons.hide(elements[i]);
                                break;
                            default:
                                elements[i].value = submittedFormDetails[elements[i].name];
                        }
            ...
            _this.addMessage = function (
                ...
                if (
                    ...
                    $mck_autosuggest_search_input.addClass('mck-text-box');
                    kommunicateCommons.show($mck_autosuggest_search_input);
                    $mck_text_box.removeClass('mck-text-box');
                    kommunicateCommons.hide($mck_text_box);
                ...
                if (msg.contentType === 23) {
                    var templateTargetSelector = "div[data-msgkey='" + msg.key + "'] .blk-lg-12";
                    if (msg.metadata.msg_type === 'BUTTON') {
                        ...
                        if (msg.metadata.payload) {
                            ...
                            if (payload.length && !payload[0].hidden) {
                                buttonElements.push(buildTemplateButton(payload[0].title));
                            }
                            if (payload.length > 1) {
                                for (var i = 1; i < payload.length; i++) {
                                    if (!payload[i].hidden) {
                                        buttonElements.push(buildTemplateButton(payload[i].title));
                                    }
                                }
                            }
                            if (buttonElements.length) {
                                var buttonFragment = d.createDocumentFragment();
                                buttonElements.forEach(function (node) {
                                    buttonFragment.appendChild(node);
                                });
                                $applozic(templateTargetSelector).after(buttonFragment);
                            }
                        } else {
                    ...
                    if (msg.metadata.msg_type === 'LIST') {
                        ...
                        if (msg.metadata.payload) {
                            ...
                            if (listElements.length) {
                                ...
                                $applozic(templateTargetSelector).after(listFragment);
                            }
                        }
                    }
                }
        ...
        display: block;
                ...
                if ($mck_tab_message_option.hasClass('n-vis')) {
                    if (msg.groupId) {
                        ...
                        if (group.type !== 6) {
                            kommunicateCommons.show('.mck-tab-message-option');
                        }
                    } else {
                        kommunicateCommons.show('.mck-tab-message-option');
                    }
            ...
            _this.addContactForSearchList = function (contact, $listId) {
                ...
                // kommunicateCommons.show("#li-" + contHtmlExpr + " .mck-group-count-box");
            ...
            _this.addContactsToSearchList = function () {
                ...
                kommunicateCommons.hide('#mck-search-loading');
                ...
                if (uniqueUserIdArray.length > 0) {
                    ...
                    kommunicateCommons.show('#mck-no-search-contacts');
                }
                ...
                $mck_autosuggest_search_input.mcktypeahead({
                    ...
                    show: function () {
                        ...
                        return (
                            ...
                            kommunicateCommons.show(this.$menu),
                            (this.shown = !0),
                            this
                        );
                    },
            ...
            _this.updateContact = function (contact, message, $listId) {
                ...
                if (message && message.createdAtTime > currentMessageTime) {
                    ...
                    if (unreadCount > 0) {
                        ...
                        kommunicateCommons.show('#li-' + contHtmlExpr + ' .mck-unread-count-box');
                    }
            ...
            _this.addGroupsToGroupSearchList = function () {
                ...
                if (MCK_GROUP_ARRAY.length > 0) {
                    ...
                    kommunicateCommons.show('#mck-no-search-groups');
                }
                _this.initAutoSuggest({
            ...
            _this.loadContacts = function (data) {
                ...
                KommunicateUI.setHasConversationHistory(MCK_CONTACT_ARRAY.length > 0);
            };
            ...
            _this.clearMessageField = function (keyboard) {
                ...
                kommunicateCommons.hide('.mck-text-req-error');
                $mck_msg_sbmt.attr('disabled', false);
                kommunicateCommons.hide($mck_file_box);
                $mck_file_box.removeClass('mck-text-req').attr('required', '').html('');
            ...
            _this.addDraftMessage = function (tabId) {
                ...
                if (tabId && typeof TAB_MESSAGE_DRAFT[tabId] === 'object') {
                    ...
                    if (draftMessage.files.length > 0) {
                        ...
                        kommunicateCommons.hide('.mck-text-req-error');
                        kommunicateCommons.show($mck_file_box);
                        $mck_file_box.removeClass('mck-text-req').removeAttr('required');
                    }
                } else {
                    FILE_META = [];
                }
            ...
            _this.showOfflineMessage = function () {
                if (
                    ...
                    kommunicateCommons.show('#mck-offline-message-box');
                } else {
        ...
        function MckGroupLayout() {
            ...
            $applozic(d)
                .on('mouseenter', '.mck-group-create-icon-box.mck-hover-on', function () {
                    kommunicateCommons.show($applozic(this).find('.mck-overlay-box'));
                })
                .on('mouseleave', '.mck-group-create-icon-box.mck-hover-on', function () {
                    var $this = $applozic(this);
                    if ($this.find('.mck-group-icon-default').length === 0) {
                        kommunicateCommons.hide($this.find('.mck-overlay-box'));
                    }
                });
            $applozic(d)
                ...
                .on('mouseleave', '.mck-group-info-icon-box.mck-hover-on', function () {
                    kommunicateCommons.hide($applozic(this).find('.mck-overlay-box'));
                });
            $mck_group_name_edit.on('click', function () {
                ...
                kommunicateCommons.show('#mck-group-name-save');
                kommunicateCommons.hide('#mck-group-name-edit');
            });
            ...
            _this.addGroupStatus = function (group) {
                ...
                if (group.type !== 6 && (isGroupLeft || IS_GROUP_SUBTITLE_HIDDEN)) {
                    ...
                    // kommunicateCommons.show('#mck-tab-status');
                    $mck_tab_title.addClass('mck-tab-title-w-status');
                    kommunicateCommons.show('.mck-group-menu-options');
                } else {
                    $mck_tab_title.removeClass('mck-tab-title-w-status');
                    kommunicateCommons.hide('#mck-tab-status');
                }
                    ...
                    if ($mck_group_info_tab.hasClass('vis')) {
                        ...
                        if (groupInfo.users && groupInfo.users.length > 0) {
                            ...
                            group.adminName === MCK_USER_ID
                                ? kommunicateCommons.show('#mck-group-add-member-box')
                                : kommunicateCommons.hide('#mck-group-add-member-box');
                        }
                    } else if ($mck_sidebox_content.hasClass('vis')) {
                        var currTabId = $mck_msg_inner.data('mck-id');
                        var isGroupTab = $mck_msg_inner.data('isgroup');
            ...
            _this.enableGroupAdminMenuToggle = function () {
                $applozic('.mck-group-member-info')
                    .bind('mouseenter', function () {
                        kommunicateCommons.show($applozic(this).find('.mck-menu-box'));
                    })
                    .bind('mouseleave', function () {
                        var menuBox = $applozic(this).find('.mck-menu-box');
                        menuBox.removeClass('open');
                        kommunicateCommons.hide(menuBox);
                    });
            };
            ...
            _this.addMembersToGroupSearchList = function () {
                ...
                if (isGroup) {
                    ...
                    searchArray.length > 0
                        ? kommunicateCommons.hide('#mck-no-gsm-text')
                        : kommunicateCommons.show('#mck-no-gsm-text');
            ...
            _this.loadCreateGroupTab = function () {
                ...
                kommunicateCommons.show($mck_group_create_overlay_box);
            ...
            _this.init = function () {
                ...
                $applozic(d).on('click', '.mck-remove-file', function () {
                    ...
                    if ($file_box.find('.mck-file-box').length === 0) {
                        kommunicateCommons.hide('#mck-file-box');
            ...
            _this.uplaodFileToAWS = function (file, medium) {
                ...
                if (uploadErrors.length > 0) {
                    ...
                    if (UPLOAD_VIA[0] === medium) {
                        kommunicateCommons.show(
                            $mck_group_create_icon_box.find('.mck-overlay-box')
                        );
                        $mck_group_create_icon_box.removeClass('mck-hover-on');
                        kommunicateCommons.show('#mck-group-create-icon-loading');
                    } else {
                        kommunicateCommons.show($mck_group_info_icon_box.find('.mck-overlay-box'));
                        $mck_group_info_icon_box.removeClass('mck-hover-on');
                        kommunicateCommons.show('#mck-group-info-icon-loading');
                    }
                    var xhr = new XMLHttpRequest();
                    xhr.addEventListener('load', function (e) {
                        ...
                        if (fileUrl) {
                            if (UPLOAD_VIA[0] === medium) {
                                ...
                                setTimeout(function () {
                                    kommunicateCommons.show('#mck-btn-group-icon-save');
                                }, 1500);
                            }
                            setTimeout(function () {
                                kommunicateCommons.hide($mck_overlay_box);
                            }, 1500);
                        }
        ...
        function MckNotificationService() {
            ...
            _this.showNewMessageNotification = function (message, contact, displayName) {
                ...
                if (!imgsrctag.indexOf('/avatars/default.png') != -1) {
                    ...
                    kommunicateCommons.show('#launcher-agent-img-container');
                    kommunicateCommons.hide('#launcher-svg-container');
                } else {
                    $applozic('#launcher-agent-img-container').html('');
                    kommunicateCommons.hide('#launcher-agent-img-container');
                    kommunicateCommons.show('#launcher-svg-container');
                }
                if (typeof CUSTOM_CHAT_LAUNCHER !== 'undefined') {
                ...
                if (messageType === 'APPLOZIC_04' || messageType === 'MESSAGE_DELIVERED') {
                    ...
                    if (!MCK_BLOCKED_TO_MAP[userId] && !MCK_BLOCKED_BY_MAP[userId]) {
                        if (tabId === contact.contactId && !$mck_message_inner.data('isgroup')) {
                            ...
                            kommunicateCommons.show('#li-user-' + htmlId + ' .mck-ol-status');
                        }
                        kommunicateCommons.show('.mck-user-ol-status.' + htmlId);
                    ...
                    if (!MCK_BLOCKED_TO_MAP[userId] && !MCK_BLOCKED_BY_MAP[userId]) {
                        ...
                        kommunicateCommons.hide('.mck-user-ol-status.' + contact.htmlId);
                        $applozic('.mck-user-ol-status.' + contact.htmlId)
                            .next()
                            .html('(Offline)');
                        kommunicateCommons.hide('#li-user-' + htmlId + ' .mck-ol-status');
                        alUserService.updateUserStatus(
                            {
                                userId: userId,
                                status: 0,
                    ...
                    if (typeof tabId === 'undefined' || tabId === '') {
                        ...
                        kommunicateCommons.hide(
                            '#li-user-' + contact.htmlId + ' .mck-unread-count-box'
                        );
                    }
                    var response = {
                        userId: userId,
                    ...
                    if (tabId === contact.contactId) {
                        ...
                        kommunicateCommons.show('#li-user-' + contact.htmlId + ' .mck-ol-status');
                    }
