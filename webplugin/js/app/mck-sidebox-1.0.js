...
//      var MCK_AWS_S3_SERVER = (appOptions.awsS3Server)?appOptions.awsS3Server:false;
        ...
        function MckMessageLayout() {
            ...
            var csatModule = '<div class="csatModule"> <div class="mck-rated"> <span class="mck-rated-text">You rated the conversation</span><span class="mck-rating-container">{{html ratingSmileSVG}}</span></div><div class="mck-conversation-comment">${ratingComment}</div></div>'
            ...
            _this.populateMessage = function (messageType, message, notifyUser) {
               ...
               !_this.isMessageSentByBot(message, contact) && $applozic('.km-typing-wrapper').remove();
                ...
                if ((typeof tabId === 'undefined') || tabId === '') {
                    ...
                    } else if (messageType === "APPLOZIC_02" && !message.contentType == 102 || messageType === "APPLOZIC_02" && message.metadata.feedback) {
                        if (((typeof message.oldKey === 'undefined' || $applozic("." + message.oldKey).length === 0) && $applozic("." + message.key).length === 0) || message.contentType === 10) {
                            if (mckContactListLength > 0) {
                                mckMessageLayout.addContactsFromMessage(message, true);
                            } else {
