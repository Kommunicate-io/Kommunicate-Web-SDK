    ...
    var mck_external_scripts = [
        {
            ...
            "url": "https://cdn.applozic.com/applozic/applozic.chat-5.8.min.js", // update the url with every new release of applozic-web-plugin
            "alternateUrl": MCK_STATICPATH + "/js/app/applozic.chat-5.7.min.js"
        }
    ];
