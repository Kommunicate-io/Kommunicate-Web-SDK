...
exports.getPlugin = (req, res) => {
  ...
  PLUGIN_SETTING.kommunicateApiUrl = PLUGIN_SETTING.kommunicateApiUrl || config.getProperties().urls.kommunicateBaseUrl;
  PLUGIN_SETTING.applozicBaseUrl = PLUGIN_SETTING.applozicBaseUrl || config.getProperties().urls.applozicBaseUrl;
