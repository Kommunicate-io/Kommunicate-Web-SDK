var MCK_CONTEXTPATH = 'https://widget-test.kommunicate.io';
var MCK_STATICPATH = 'https://widget-test.kommunicate.io/plugin';
var MCK_ONINIT = '';
var KM_PLUGIN_SETTINGS = JSON.parse('{"pseudoNameEnabled":true,"kommunicateApiUrl":"https://api-test.kommunicate.io","botPlatformApi":"https://bots-test.kommunicate.io","applozicBaseUrl":"https://chat-test.kommunicate.io","dashboardUrl":"https://dashboard-test.kommunicate.io"}');
var MCK_PLUGIN_VERSION = 'v1';
var MCK_THIRD_PARTY_INTEGRATION = JSON.parse('{"sentry":{"dsn":"https://b1187d11fbdc4632b29259b258dd9053@o418176.ingest.sentry.io/5338197","enabled":true},"aws":{"cdnUrl":"https://cdn-test.kommunicate.io","bucket":"kom-test-cdn"}}');
...
function addKommunicatePluginToIframe() {
    ...
    imported.src = "https://widget-test.kommunicate.io/plugin/build/kommunicate.9eeafb67.min.js";
