...
(function(window) {
    ...
    Fr.voice = {
         ...
         */
        record: function(output, finishCallback, recordingCallback,errorCallBackFunc) {
            var errorCallBack = errorCallBackFunc || function() {};
            ...
            if (navigator.getUserMedia) {
                navigator.getUserMedia({ audio: true }, callBack, function(
					...
					errorCallBack(err)
                    alert("No live voice input please allow microphone into your browser and try again");
                });
