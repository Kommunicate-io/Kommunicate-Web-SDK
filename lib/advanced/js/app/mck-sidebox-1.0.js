...
(function($applozic, w, d) {
    ...
    function Applozic(appOptions) {
        ...
        _this.reInit = function(optns) {
            ...
            MCK_DEFAULT_MESSAGE_METADATA = (typeof appOptions.defaultMessageMetaData === 'undefined') ? "" : appOptions.defaultMessageMetaData;
        ...
        _this.sendMessage = function(params) {
            if (typeof params === "object") {
                ...
                var to = params.to;
                message.defaultMessageMetaData = MCK_DEFAULT_MESSAGE_METADATA;
