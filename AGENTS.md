...
-   Keep generated CSS in sync: run `npm run lint:scss-sync` to verify key SCSS entries (style, bottom nav, tab visibility) match their compiled CSS before committing.
