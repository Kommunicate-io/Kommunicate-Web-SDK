...
export const NativeScript = props => (
    <svg width="512" height="512" viewBox="0 0 260.1 260.1" {...props}>
      <path
        d="M0 195a65 65 0 0 0 65 65h130a65 65 0 0 0 65-65V65a65 65 0 0 0-65-65H65A65 65 0 0 0 0 65v130z"
        fill="#3d5afe"
      />
      <path
        d="M238.4 130c-12 0-21.7-9.7-21.7-21.6V65c0-12-9.7-21.7-21.6-21.7h-21.7v108.4L86.7 43.4H65C53 43.3 43.3 53 43.3 65v43.4c0 12-9.7 21.6-21.6 21.6 12 0 21.6 9.7 21.6 21.7v43.4c0 12 9.8 21.6 21.7 21.6h21.7V108.4l86.7 108.3H195c12 0 21.6-9.7 21.6-21.6v-43.4c0-12 9.7-21.7 21.7-21.7z"
        fill="#fff"
      />
    </svg>
  )
