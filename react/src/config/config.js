...
var config = {
  prod: {
      ...
      applicationList:baseurl.prod.baseUrl+'/rest/ws/user/getlist?userId=:userId&roleNameList=APPLICATION_ADMIN&roleNameList=APPLICATION_WEB_ADMIN',
  ...
  dashboard:{
    homeUrl:baseurl.dashboard.baseUrl,
     applozicPlugin:{
      ...
      addBotUrl: 'http://dashboard-test.applozic.com:5454/bot',
      applicationList:baseurl.dashboard.baseUrl+'/rest/ws/user/getlist?userId=:userId&roleNameList=APPLICATION_ADMIN&roleNameList=APPLICATION_WEB_ADMIN',
  ...
  test:{
     ...
     applozicPlugin:{
      ...
      applicationList:baseurl.test.baseUrl+'/rest/ws/user/getlist?userId=:userId&roleNameList=APPLICATION_ADMIN&roleNameList=APPLICATION_WEB_ADMIN',
  ...
  development: {
    ...
    applozicPlugin:{
      ...
      addBotUrl: 'http://dashboard-test.applozic.com:5454/bot',
      statsUrl:'https://apps-test.applozic.com/rest/ws/stats/get?appKey=:appKey',
      applicationList:baseurl.default.baseUrl+'/rest/ws/user/getlist?userId=:userId&roleNameList=APPLICATION_ADMIN&roleNameList=APPLICATION_WEB_ADMIN',
      statsFilterUrl:"https://apps-test.applozic.com/rest/ws/stats/filter?appKey=:appKey",
