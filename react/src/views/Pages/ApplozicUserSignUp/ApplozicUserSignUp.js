            ...
            <hr className="hr"/>
              <div className="card mx-4">
                <div className="card-block p-4 signup-card-block">
                  ...
                  <p className="setup-sub-heading text-center">Enter your applozic details</p>
                  ...
                  <div className="row applozic-user-signup-btn-row">
                    <div className="col-12 text-center">
                      <button type="button" id="applozic-user-signup" className="km-button km-button--primary step-1-submit-btn" onClick= { this.buttonActions }>Sign Up</button>
