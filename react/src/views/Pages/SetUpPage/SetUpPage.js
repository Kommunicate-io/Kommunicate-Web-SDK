			...
			<div className="app setup-pages-bg">
				...
				<div className="row justify-content-center">
					<div className="col-md-11 card">
						...
						{this.state.step === 1 ? <Step1 moveToNextStep={this.moveToNextStep} hideSkipForNow={this.props.hideSkipForNow} location={this.props.location} /> 
											   : this.state.step === 2 ? <Step2 moveToNextStep={this.moveToNextStep} customerInfo={this.state.customerDetail} history={this.props.history}/>:<Step3 customerInfo={this.state.customerDetail} hideSkipForNow={this.props.hideSkipForNow} history={this.props.history}/>}
					</div>
				</div>
			</div>
		)
