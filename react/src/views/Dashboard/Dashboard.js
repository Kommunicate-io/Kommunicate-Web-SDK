      ...
      <div className="animated fadeIn dashboard-card">
        <div className="row filter-dropdown-wrapper">
          ...
          <div className="col-lg-2 col-sm-4 tooltip-for-lock">
            ...
            <Select
              className={((CommonUtils.getDaysCount() < 31 ) && (typeof CommonUtils.getUserSession().subscription === 'undefined' || CommonUtils.getUserSession().subscription == '' || CommonUtils.getUserSession().subscription == '0' || CommonUtils.getUserSession().subscription === "startup")) ? "" : (typeof CommonUtils.getUserSession().subscription === 'undefined' || CommonUtils.getUserSession().subscription == '' || CommonUtils.getUserSession().subscription == '0' || CommonUtils.getUserSession().subscription === "startup") ? "agent-restriction" : ""}
