  ...
  render() {
    return (
      ...
      {/* Change showNewBot to false to hide new bot section*/}
        <div className={(CommonUtils.isTrialPlan()) ? "card" : (CommonUtils.isStartupPlan()) ? "n-vis" : "card"} style={{display:"block"} }>
        ...
        <div className={(CommonUtils.isTrialPlan()) ? "n-vis" : (CommonUtils.isStartupPlan()) ? "upgrade-plan-container upgrade-plan-bot-integration" : "n-vis"}>
