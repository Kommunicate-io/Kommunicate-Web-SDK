            ...
            if (user.messagePxy && user.messagePxy.groupId) {
              window.$kmApplozic.fn.applozic("getGroupFeed", { groupId: user.messagePxy.groupId,
                callback: function(group) {
                  if (botAgentMap && typeof group !== "undefined" && group !== null && group.data.metadata &&                group.data.metadata.CONVERSATION_ASSIGNEE && botAgentMap[group.data.metadata.CONVERSATION_ASSIGNEE]) {
