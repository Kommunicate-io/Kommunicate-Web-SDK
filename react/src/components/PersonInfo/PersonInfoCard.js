                    ...
                    <div className="km-box-top">
                        ...
                        <div className="km-display-email-number-wrapper">
                            <div className="km-postion-relative">
                                ...
                                {
                                    this.state.user ?
                                        <EditableText id ="km-sidebar-user-email" style={this.state.email ?"km-sidebar-user-email":"km-sidebar-user-emailnotfound"} keyname={this.state.user.userId} reference={"email"} value={this.state.user.email} placeholder={"Add Email"} /> : null
                                }
                            </div>
                            <div className="km-postion-relative">
                                <p>
                                ...
                                {
                                    this.state.user ?
                                        <EditableText id ="km-sidebar-user-number" style={this.state.phoneNumber ?"km-sidebar-user-number":"km-sidebar-user-numbernotfound"} className ="km-sidebar-user-number-edit" inputType={"number"}  keyname={this.state.user.userId} reference={"phoneNumber"} value={this.state.user.phoneNumber} placeholder={"Add Phone Number"}/> : null
                                }
                            </div>
                        </div>
                    </div>
