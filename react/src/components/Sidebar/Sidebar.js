      ...
      <div className="sidebar">
        <nav className="sidebar-nav">
          <ul className="nav">
            ...
            <li className="nav-item">
              <NavLink to={'/dashboard'} className="nav-link" activeClassName="active" data-rh="Dashboard" data-rh-at="right" data-tip="Dashboard" data-effect="solid" data-place="right"><svg xmlns='http://www.w3.org/2000/svg' id='Layer_1' dataName='Layer 1'
viewBox='0 0 44.5 27.8'>
    ...
    transform='translate(-1.8 -10.1)' />
            ...
            */}
            ...
            <li className="nav-item">
              <NavLink to={'/conversations'} className="nav-link" activeClassName="active" data-tip="Conversations" data-effect="solid" data-place="right"><svg xmlns='http://www.w3.org/2000/svg' id='Layer_1' dataName='Layer 1'
viewBox='0 0 45.8 40'>
    ...
    transform='translate(-1.1 -4)' />
            ...
            <li className="nav-item">
              <NavLink to={'/users'} className="nav-link" activeClassName="active" data-tip="Users" data-effect="solid" data-place="right"><svg xmlns='http://www.w3.org/2000/svg' id='Layer_1' dataName='Layer 1'
viewBox='0 0 45.8 34.6'>
    ...
    transform='translate(-1.1 -6.7)' />
            ...
            */}
            ...
            <li className="nav-item">
              <NavLink to={'/bot'} className="nav-link" activeClassName="active"  data-tip="Bot" data-effect="solid" data-place="right"><svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" dataName="Layer 1"
viewBox="0 0 42 46.4" className="bot-icon-svg">
