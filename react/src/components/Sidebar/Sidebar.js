    ...
    <circle className="cls-1" cx="29.7" cy="27.1" r="2.5" />
            ...
            {/* <li className="nav-item">
              <NavLink to={'/settings/integration'} className="nav-link" activeClassName="active"><i className="fa fa-gear"></i> Integration</NavLink>
                  ...
                  <li className="nav-item">
                    <NavLink to={'/admin'} className={(currentPath.includes('integration') || currentPath.includes('admin') || currentPath.includes('team') || currentPath.includes('message-shortcuts') || currentPath.includes('download')) ? "nav-link active" : "nav-link"} activeClassName="active" data-tip="Settings" data-effect="solid" data-place="right"><svg xmlns='http://www.w3.org/2000/svg' id='Layer_1' viewBox='0 0 46 46'>
