...
class InputFile extends Component {
    ...
    render () {
        ...
        const brandColor = this.props.theme.primary;
        ...
        return(
            <div style={{display: 'flex'}}>
                ...
                <label htmlFor={id} className={(className === 'secondary') ? "km-button km-button--secondary km-btn-file-label" : "km-button km-button--primary km-btn-file-label"}>
                ...
                <span hidden={this.state.hideCloseBtn} onClick={() => this.removeSelectedFiles( id, text)} className="close-btn-container">
                    <svg xmlns="http://www.w3.org/2000/svg"  fill={(className === 'secondary') ? brandColor : "#FFF"} height="24" viewBox="0 0 24 24" width="24" style={{margin: "8px 10px -5px 10px", zIndex:20, width:"20px", height:"20px"}}>
