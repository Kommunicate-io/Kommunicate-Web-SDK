                      ...
                      <div className="km-box-top">
                        ...
                        <div className="km-display-email-number-wrapper">
                          <div className="km-postion-relative">
                            ...
                            <input id="km-sidebar-user-email-edit" type ="text" className="km-sidebar-user-email" size="100" placeholder="Add Email" ></input>
                          ...
                          <div className="vis km-postion-relative">
                            ...
                            <input id="km-sidebar-user-number-edit" placeholder ="Add Phone Number" type="number" min="0" size="20" className="km-sidebar-user-number"  onKeyDown={(e) => this.onKeyDown(e)}></input>
                            <div className="km-sidebar-svg">
